 ...
 * Change Log :
 * 
 *  7/7/23 - get database connection from System.getenv() instead of WEB.XML
 * 
...
public class SessionMgr {
	...
	public String getTemplatesPath() {
		debug ("templates: " + System.getenv("templates_url"));
		return System.getenv("templates_url");
	}

	public String getAppVersion() {
		return (String) servletContext.getInitParameter("Application-Version");
	...
	private Connection openConnection() throws services.ServicesException {
		...
		debug("password : " + System.getenv("db_pwd"));
		debug("user : " + System.getenv("db_user"));
		debug("url : " + System.getenv("db_url"));
		
		
		// db url : jdbc:mariadb://192.168.1.4:3306/pmo 
